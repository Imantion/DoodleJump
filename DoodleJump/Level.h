...
public:
	...
	int generateLevel(std::vector<Platform*>& platforms, std::list<Enemy*>& enemies, MemoryPool* enemyMemoryPool, bool isFirstLevelGeneration); // isFirstLevelGeneration is used to prevent spawning platform on enemy
